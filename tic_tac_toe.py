...
def win_check(board, mark):
    ...
    return (
        ...
        or (board[4] == board[5] == board[6] == mark)  # across
        or (board[1] == board[2] == board[3] == mark)  # across
        or (board[7] == board[4] == board[1] == mark)  # across
        or (board[8] == board[5] == board[2] == mark)  # down
        or (board[9] == board[6] == board[3] == mark)  # down
        or (board[7] == board[5] == board[3] == mark)  # down
